...
class ToolSugiyama(ToolPluginInterface):
    ...
    def doAction(self):
        ...
        self.__createInterfaceOglALayout(selectedObjects)
    ...
    def __fixNodesPositions(self):
        ...
        if ToolSugiyama.STEP_BY_STEP:     # TODO Make this a User/Plugin Preference
            SugiyamaGlobals.waitKey(self._communicator)
        else:
            ...
            for level in self.__levels:
                for node in level:
                    if node.balance():
                        ...
                        if ToolSugiyama.STEP_BY_STEP:
                            SugiyamaGlobals.waitKey(self._communicator, msg)
                        else:
