...
setup(
    ...
    package_data={
        ...
        'coreinterfaces':            ['py.typed'],
        'coreinterfaces.coretypes':  ['py.typed'],
        'coreinterfaces.exceptions': ['py.typed'],
    },
    packages=[
        ...
        'coreinterfaces', 'coreinterfaces.coretypes', 'coreinterfaces.exceptions',
    ],
